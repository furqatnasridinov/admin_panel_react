...
export default function Memberships() {
    const greenBorder = "1px solid rgba(58, 185, 109, 1)";
  ...
  return (
    <div className='customCard'>
        <div className="rowSpaceBetween">
            ...
            <CrmWhiteButton text='Добавить абонемент' />
        </div>

        <VerticalSpace height='32px' />
        <div style={{border : greenBorder}} className="greenContaner">
            <div className="rowSpaceBetween">
                <div className="max-w-[75%] h-fit flex flex-wrap gap-[10px] items-center p-[1px]">
                        <LessonTypeCard />
                        <LessonTypeCard lessonType='Айкидо' icon={<MassageSvg />} />
                        <span className='label2b text-crm-link'>/</span>
                        <SubCategoryCard text='Павел Скайуокер' />
                        <SubCategoryCard text='Александр Вейдер' />                        
                </div>
                <div className="rowGap10">
                    <div className="columnWithNoGap">
                        <span className='interBody3Plus'>32 000₽</span>
                        <span className='text-[10px] font-medium leading-3 '>36 000₽</span>
                    </div>
                    <GreenButton 
                        text='Продлить' 
                        showShadow = {true} 
            ...
            <div className="columnWithNoGap">
                <span className='headerH2'>Бойцовский клуб. Вечерний</span>
                <span className='label2'>Этот вид абонемента включает посещение секций бокса и айкидо, в вечернее время с 18:00 до 21:00.</span>
            </div>
            <VerticalSpace height='16px' />
            <Indicator />
        </div>
